...
imagen = cv2.imread("cebra.jpg") # Se lee la imagen

escala = 2
imagen = cv2.resize(imagen, None, fx=escala, fy=escala) # Se cambia el tamaño de la imagen

fondo = cv2.imread("catedral.jpg") # Se lee el fondo
...
mask = cv2.inRange(imagenHSV, (50, 200, 200), (70, 255, 255)) # Se obtiene la mascara de la imagen
